...
Smokeing = st.sidebar.selectbox(label='Smoke', options=[0,1], index=1)
Drinking = st.sidebar.selectbox(label='Drink', options=[0,1], index=1)
Diabetes = st.sidebar.selectbox(label='Diabetes', options=[0,1], index=1)
Heart_disease = st.sidebar.selectbox(label='Heart.disease', options=[0,1], index=1)
