...
BMI = st.sidebar.number_input(label='BMI', min_value=15.20,
                                  ...
                                  value=15.20,
                                  step=0.01)
Smokeing = st.sidebar.selectbox(label='Smokeing', options=[0,1], format_func=lambda x: option_name(x), index=0)
Drinking = st.sidebar.selectbox(label='Drinking', options=[0,1], format_func=lambda x: option_name(x), index=0)
